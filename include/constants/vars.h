...
#define VAR_SELECT_STARTER_REGION                        0x40F7 // Select Starter Region
#define VAR_LITTLEROOT_STATE                             0x40F8 // Littleroot state if collected mon and fought rival
#define VAR_STARTER_CHOICE                               0x40F9 // Starter Chocie Selected
